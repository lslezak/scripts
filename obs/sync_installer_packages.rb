...
PACKAGES = [ "autoyast2", "libstorage", "libyui", "libyui-bindings",
  ...
  "yast2-product-creator", "yast2-proxy", "yast2-restore", "yast2-ruby-bindings",
